...
function y = solution_exacte(t)
    y = 1-exp(-t^2/2); endfunction

T=4; N=20; //intervalle et nombre de points
h=T/N; t=[0:h:T]; //pas et subdivision
y=point_milieu(0,t,f1); //approximation par le schema

clf; subplot(2,1,1); plot(t,y,'ro'); plot(t,solution_exacte(t),'bo');
...
subplot(2,1,2);
plot(t(10:16),y(10:16),'ro'); plot(t(10:16),solution_exacte(t(10:16)),'bo');
