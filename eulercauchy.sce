...
t=[0:h:T]; //subdivision
y0=0;
y=euler_cauchy(0,t,f1); //approximation par le schema

clf;
subplot(2,1,1);
plot(t,y,'ro');
plot(t,solution_exacte(t),'bo');
legend(["Schema Euler-Cauchy";"Solution exacte"],opt=4);
title("Application du schema d''Euler-Cauchy",'fontsize',5);
