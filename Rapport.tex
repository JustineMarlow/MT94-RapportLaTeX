...
\chapter*{Résumé}
\markboth{RESUME}{}
Ce cahier d'intégration reprend l'ensemble des activités réalisées dans le cadre de l'unité de valeur MT94, cours d'introduction aux mathématiques appliquées enseigné à l'Université de Technologie de Compiègne. Il reprend le contenu des cours magistraux mais aussi et surtout les activités réalisées en séance de travaux pratiques et de travaux hors encadrement. Tout au long du semestre, ces activités ont reposées sur des résolution de problèmes scientifiques. \\
\indent La rédaction et la mise en page de ce cahier sont encore perfectibles. Toutefois, j'ai veillé à introduire tout ce qui me paraissait important. La dernière compilation de ce cahier date du 19 juin 2017. \\
\indent Je remercie S.Mottelet et D.Katheb pour leur implication pédagogique au sein de cette UV tout au long du semestre.
...
\begin{tabular}{l}
\lstinputlisting[language=scilab]{pendule_ode.sce}
...
\begin{tabular}{l}
\lstinputlisting[language=scilab]{proie_predateur_ode.sce}
